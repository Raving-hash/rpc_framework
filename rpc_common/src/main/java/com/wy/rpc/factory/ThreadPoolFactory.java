...
import com.google.common.util.concurrent.ThreadFactoryBuilder;import org.slf4j.Logger;
...
public class ThreadPoolFactory {
    ...
    private static ThreadFactory createThreadFactory(String threadNamePrefix, Boolean daemon) {
        ...
        if (threadNamePrefix != null) {
            threadFactory = daemon != null? new ThreadFactoryBuilder().setNameFormat(threadNamePrefix + "-%d").setDaemon(daemon).build()
